"use client"
import { Flex, FormControl, Icon, IconButton, Textarea } from "@chakra-ui/react";
import { Field, Formik } from "formik";
import { Session } from "next-auth";
import React, { useState } from "react";
import { FaImage, FaLocationArrow, FaMicrophone, FaSmile } from "react-icons/fa";
...
const InputMessage: React.FC<InputMessageProps> = (props) => {
  ...
  const [sendMessage, {data, loading, error}] = useMutation(MessageOperations.Mutation.sendMessage)
  ...
  const handleSendMessage = (values: any) => {
    sendMessage({
      variables: {
        conversationId: "",
        senderId: "2831e88c-674f-4d4e-91a5-4dec22f91f24",
        recipientId: "e7f64345-cc1b-4088-9b74-33f55ffc4078",
  ...
  return (
    ...
    >
      {({ handleSubmit, errors, touched }) => {return(
